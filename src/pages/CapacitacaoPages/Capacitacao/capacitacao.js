...
export default function Capacitacao({ navigation }) {
  {/**   const [praticas, setPraticas]=useState([])
    useEffect(()=>{
        ...
        carregarPraticas.then((res)=>{
            setPraticas(res.data)
        })
        carregarPraticas.catch((err)=>{
  ...
  const praticaTeste = [
      ...
      "practiceAdvantage": [
        {
          ...
          "description": "Combina várias técnicas para controlar pragas, incluindo uso de predadores naturais e práticas culturais."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "practiceAdvantage": [
        {
          "id": 10,
          "advantage": "Promove a conservação da biodiversidade, sequestro de carbono e gera receita adicional com produtos florestais.",
...
const TituloDaPratica = styled.Text`
width: 50%;
...
const ComponenteDeTexto = styled.Text`
width: 190px;
`